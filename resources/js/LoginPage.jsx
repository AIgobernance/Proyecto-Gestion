              ...
              {resetError && (
                ...
                />
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                      <Label htmlFor="reset-new-password" style={{ color: "#0b1324", fontWeight: 600, fontSize: 14 }}>
                        Nueva contraseña
                      </Label>
                      <Input
                        ...
                        disabled={isSubmitting}
                        style={{ borderRadius: "12px", padding: "12px 16px", border: "2px solid #e2e8f0", fontSize: 15 }}
                      />
                    </div>

                    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                      <Label htmlFor="reset-confirm-password" style={{ color: "#0b1324", fontWeight: 600, fontSize: 14 }}>
