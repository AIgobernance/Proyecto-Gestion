...
/* =======================================================================
   Reemplazos livianos: Slot y Icono
======================================================================= */
...
/* =======================================================================
   Trigger / Rail / Inset / Inputs y secciones
======================================================================= */
...
function SidebarGroup({ className, ...props }) {
  return <div data-slot="sidebar-group" data-sidebar="group" className={cn("relative flex w/full min-w-0 flex-col p-2".replace("/full","/full"), className)} {...props} />;
}
...
/* =======================================================================
   Menú y variantes (reemplazo cva)
======================================================================= */
function sidebarMenuButtonClasses({ variant = "default", size = "default" } = {}) {
...
/* =======================================================================
   Agrupadores y contenedores simples
======================================================================= */
function SidebarGroupContent({ className, ...props }) {
  return <div data-slot="sidebar-group-content" data-sidebar="group-content" className={cn("w-full text-sm", className)} {...props} />;
}
function SidebarMenuSubItemWrapper({ className, ...props }) { return <li className={cn(className)} {...props} />; }
